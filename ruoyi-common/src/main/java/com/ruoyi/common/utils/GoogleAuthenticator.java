...
public class GoogleAuthenticator {
    ...
    public static final String SEED = "g8GjEvTbWdfVS8cavLZdwIHqGoUYNzKfe7izOF8GwLJV3s2m0QN7vxRs2im5MDaNCWGmcD2rvcZ1";
    ...
    public static String makeOtpURL(String name, String host, String secret) {
        String format = "otpauth://totp/%s@%s?secret=%s";
        return String.format(format, name, host, secret);
    }
